...
import com.mgoutad.listener.BootReceiver;
import com.mgoutad.listener.ScreenReceiver;
import com.mgoutad.listener.UserPresentReceiver;
import com.mgoutad.manager.RuleManager;
...
import com.mgoutad.v4.ActivityCompat;
import com.mgoutad.v4.ContextCompat;

import static android.Manifest.permission.ACCESS_COARSE_LOCATION;
import static android.Manifest.permission.READ_PHONE_STATE;
import static android.Manifest.permission.WRITE_EXTERNAL_STORAGE;
import static android.os.Build.VERSION_CODES.M;
import static com.mgoutad.ooa.MConstant.sence.screen_on;
import static com.mgoutad.utils.SystemUtils.checkPasswordToUnLock;
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (ContextCompat.checkSelfPermission(activity.getApplicationContext(), READ_PHONE_STATE)
                            ...
                            activity.startService(new Intent(activity, com.mgoutad.ooa.MiiService.class));
                        }
                    }
                },5000);
