...
public class ActivityCompat extends ContextCompat {
    ...
    /**
     * Backwards compatible implementation of {@link Activity#getReferrer()
     ...
     *    reported to {@link ActivityCompat.OnRequestPermissionsResultCallback#onRequestPermissionsResult(
     *    int, String[], int[])}.
     *
