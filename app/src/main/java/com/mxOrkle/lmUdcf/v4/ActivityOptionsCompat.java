...
public class ActivityOptionsCompat {
    ...
    public static ActivityOptionsCompat makeCustomAnimation(Context context,
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            return new ActivityOptionsCompat.ActivityOptionsImplJB(
    ...
    private static class ActivityOptionsImplJB extends ActivityOptionsCompat {
        ...
        public void update(ActivityOptionsCompat otherOptions) {
            if (otherOptions instanceof ActivityOptionsCompat.ActivityOptionsImplJB) {
                ActivityOptionsCompat.ActivityOptionsImplJB otherImpl = (ActivityOptionsCompat.ActivityOptionsImplJB)otherOptions;
     ...
     * {@link android.support.v4.app.ActivityCompat#startActivity(Activity, android.content.Intent, Bundle)}.
